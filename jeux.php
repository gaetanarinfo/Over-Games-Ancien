...
<?php if($_GET['item'] == "" OR $resultat_site_internet11_2['item'] != $_GET['item'])
{
	die('<META HTTP-equiv="refresh" content=0;URL=/tests>');
}
...
<meta charset="utf-8">
	...
	<title><?php echo $resultat_site_internet11['Titre_Page_Head']; ?> | <?php echo $resultat_site_internet11_2['Titre']; ?></title>
	<meta name="description" content="<?php echo $resultat_site_internet11_2['Paragraphe']; ?>">
	<meta name="author" content="<?php echo $resultat_site_internet11['Créateur_Page']; ?>">
	<link rel="icon" type="image/png" href="<?php echo $resultat_site_internet11['Favicon_Page']; ?>">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="identifier-url" content="https://over-games.fr/jeux?item=<?php echo $resultat_site_internet11_2['item']; ?>">
	
	<meta property="og:site_name" content="OverGames72">
		<meta property="og:title" content="<?php echo $resultat_site_internet11_2['Titre']; ?>">
		<meta property="og:description" content="<?php echo $resultat_site_internet11_2['Paragraphe']; ?>">
		<meta property="og:type" content="article">
		<meta property="og:url" content="https://over-games.fr/jeux?item=<?php echo $resultat_site_internet11_2['item']; ?>">
		<meta property="og:image" content="<?php echo $resultat_site_internet11_2['petiteimage']; ?>">
        
        <meta name="twitter:card" content="summary">
        <meta name="twitter:creator" content="Gaetan seigneur">
        <meta name="twitter:site" content="Over-Games">
        <meta name="twitter:title" content="<?php echo $resultat_site_internet11_2['Titre']; ?>">
        <meta name="twitter:description" content="<?php echo $resultat_site_internet11_2['Paragraphe']; ?>">
        <meta name="twitter:url" content="https://over-games.fr/jeux?id=<?php echo $resultat_site_internet11_2['item']; ?>">
        <meta name="twitter:image:src" content="<?php echo $resultat_site_internet11_2['petiteimage']; ?>">
...
.rating strong {display: block;font-size: 80px;line-height: 80px;color: rgba(11, 99, 152, 0.7) !important;text-shadow: 2px 2px 0 rgba(255,255,255,.5), 0px 0 1px rgb(48, 109, 148) !important;border-bottom: 5px solid #428bca;margin: 0 auto;margin-top: -23px;padding-bottom: 8px;max-width: 50px;text-align: center;}
#story-page .story-body, #story-page .summary, #story-page .story-conclusion {
text-align: justify;
font-size: 12px;
line-height: 21px;margin-top: 0px;padding: 0 0px;}
.important .summary {
margin-left: 130px;
text-align: justify;
...
<!-- BEGIN FEATURED BACKGROUND ELEMENT (only on the front page, hide when paged) -->
    ...
    <div class="powerup-single-wrapper-inner" style="margin-right: -8px; border-right: none;">
        ...
        <!-- BEGIN FEATURED IMAGE -->
                    ...
                    <!-- BEGIN FEATURED IMAGE -->
                    <a>
                        <img width="720" height="405" title="<?php echo $resultat_site_internet11_2['Titre']; ?>" src="<?php echo $resultat_site_internet11_2['image']; ?>" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="<?php echo $resultat_site_internet11_2['Titre']; ?>">                    </a>
                    <!-- END FEATURED IMAGE -->
                </div>
                            <!-- END FEATURED IMAGE -->
        ...
        <div class="entry-content-wrapper">
            <div class="entry-content">
                <!-- BEGIN DATE -->
                <div class="post-date">
                    Posté il y a <?php echo AffDate($resultat_site_internet11_2['DDate']); ?><span>|</span>
                    Par <?php echo $resultat_site_internet11_2['createur']; ?>
                </div>
                <!-- END DATE -->
                ...
                <div class="post-author" style="margin-top: 20px;margin-bottom: 20px;">
                    <!-- BEGIN AUTHOR AVATAR -->
                    <a href="" rel="author">
                        <img alt="" style="background-color: transparent; width: 90px !important; height: 90px !important;" src="<?php if(empty($resultat_site_internet11_2['petiteimage'])) { ?>image/Achat/nocover.png<?php }else{ ?><?php echo $resultat_site_internet11_2['petiteimage']; ?><?php } ?>" class="avatar avatar-74 photo">                    </a>
                    <!-- END AUTHOR AVATAR -->
                    <!-- BEGIN AUTHOR DESCRIPTION -->
                    <div class="author-desc-wrapper">
                       <span class="author-position"><?php if(empty($resultat_site_internet11_2['Titre'])) { ?>Aucun Nom pour ce jeux<?php }else{ ?><b><?php echo $resultat_site_internet11_2['Titre']; ?></b><?php } ?></span>
                        <div class="author-description">
                            <b><?php echo $resultat_site_internet11_2['Tags']; ?></b><br>
                            <?php if(empty($resultat_site_internet11_2['Disponible'])) { ?>La date de sortie de ce jeux et inconnu<?php }else{ ?><?php echo $resultat_site_internet11_2['Disponible']; ?><?php } ?>   <br>
                             <?php if(empty($resultat_site_internet11_2['Categorie1'])) { }else{ ?>
              <div style="cursor: pointer;margin-top: 4px;text-decoration: none;"><a class="TagsConsole label pull-left" style="margin-left: 0px; margin-top: 3px; font-weight:bold; font-size:12px;"><?php echo $resultat_site_internet11_2['Categorie1']; ?><?php } ?></a>
              <?php if(empty($resultat_site_internet11_2['Categorie2'])) { }else{ ?>
             <a class="TagsConsole label pull-left" style="margin-left: 3px; margin-top: 3px; font-weight:bold; font-size:12px;"><?php echo $resultat_site_internet11_2['Categorie2']; ?><?php } ?></a>
              <?php if(empty($resultat_site_internet11_2['Categorie3'])) { }else{ ?>
              <a class="TagsConsole label pull-left" style="margin-left: 3px; margin-top: 3px; font-weight:bold; font-size:12px;"><?php echo $resultat_site_internet11_2['Categorie3']; ?><?php } ?></a>
              <?php if(empty($resultat_site_internet11_2['Categorie4'])) { }else{ ?>
              <a class="TagsConsole label pull-left" style="margin-left: 3px; margin-top: 3px; font-weight:bold; font-size:12px; "><?php echo $resultat_site_internet11_2['Categorie4']; ?><?php } ?></a>         
               <?php if(empty($resultat_site_internet11_2['Categorie5'])) { }else{ ?>
              <a class="TagsConsole label pull-left" style="margin-left: 3px; margin-top: 3px; font-weight:bold; font-size:12px; "><?php echo $resultat_site_internet11_2['Categorie5']; ?><?php } ?></a>  
              <?php if(empty($resultat_site_internet11_2['Categorie6'])) { }else{ ?>
              <a class="TagsConsole label pull-left" style="margin-left: 3px; margin-top: 3px; font-weight:bold; font-size:12px; "><?php echo $resultat_site_internet11_2['Categorie6']; ?><?php } ?></a>          
               <?php if(empty($resultat_site_internet11_2['Categorie7'])) { }else{ ?>
              <a class="TagsConsole label pull-left" style="margin-left: 3px; margin-top: 3px; font-weight:bold; font-size:12px; "><?php echo $resultat_site_internet11_2['Categorie7']; ?><?php } ?></a>    
              <?php if(empty($resultat_site_internet11_2['Categorie8'])) { }else{ ?>
              <a class="TagsConsole label pull-left" style="margin-left: 3px; margin-top: 3px; font-weight:bold; font-size:12px; "><?php echo $resultat_site_internet11_2['Categorie8']; ?><?php } ?></a>  </div>                      </div>
                    </div>
                ...
                <article id="post-658" class="post-658 post type-post status-publish format-standard has-post-thumbnail hentry category-highlighted category-images category-news category-video tag-bonfire-themes tag-powerup tag-wordpress">
                    ...
                    <div class="entry-title">
                        <a title="<?php echo $resultat_site_internet11_2['Titre'] ?>" rel="bookmark">
                            <h1>Test complet de <?php echo $resultat_site_internet11_2['Titre'] ?> - Testé pour <?php echo $resultat_site_internet11_2['plateforme'] ?></h1>
                        </a>
                    </div>
                    <!-- END TITLE -->
                    ...
                    <!-- BEGIN CONTENT -->
						            ...
						            <div align="center"><?php echo parseZCode($resultat_site_internet11_2['Description']) ?></div>
						            
						          <hr style="margin-top: 66px;">
                   
                 <div class="ed__review__pn center-xs js-plus-minus" style="
    margin-left: -20px;
">
                                    
<div class="ed__review__pn__col">
                                        <h4 class="gk__t2 ed__review__pn__positive" style="
    margin-left: auto;
"><i class="fa fa-thermometer-quarter" aria-hidden="true"></i><!-- <i class="fa fa-thermometer-quarter" aria-hidden="true"></i> --> Les Plus</h4>
                                        <div class="ed__review__pn__list--positive end-xs">
                                            <br>
                                             <ul><?php echo $resultat_site_internet11_2['plus'] ?></ul>                                                                                                              
                               
                                        </div>
                                    </div>
                                    <div class="ed__review__pn__col">
                                        <h4 class="gk__t2 ed__review__pn__negative" style="margin-left: auto;"><i class="fa fa-thermometer-quarter" aria-hidden="true"></i><!-- <i class="fa fa-thermometer-quarter" aria-hidden="true"></i> --> Les Moins</h4>

                                        <div class="ed__review__pn__list--negative end-xs">
                                            <br>
                                                    
                                                     <ul><?php echo $resultat_site_internet11_2['moin'] ?></ul>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div align="center" style="padding-top: 17px;">
                                        ...
                                        <div class="rating" style="float: none;">
                                                <strong class="big">
                                                      <?php echo $resultat_site_internet11_2['note'] ?>                                                </strong>
                                                <p style="padding-top: 15px;padding-bottom: 11px;"><span style="font-weight:bold;font-size: 20px;color: white;"><?php echo $resultat_site_internet11_2['notetitre'] ?></span></p>
                                  </div>   
                                 ...
                                 <?php if(empty($resultat_site_internet11_2['jaquette'])) { ?>
...
<div align="center" style="">
		...
		<div style="max-width: 204px;">
					...
					<a>
						<img src="image/Jaquette/<?php echo $resultat_site_internet11_2['jaquette'] ?>" alt="Jaquette de <?php echo $resultat_site_internet11_2['Titre'] ?>" title="Jaquette de <?php echo $resultat_site_internet11_2['Titre'] ?>" style="width: 100%;">
					</a>
				</figure>
			</div>
		</div>
        ...
        <?php if(!empty($resultat_site_internet11_2['specification']) && !empty($resultat_site_internet11_2['specification2'])) { ?>
<br>
	  
	  <div align="center">
		  <ul style="display: block;font-size: 12px;list-style:none;margin: 0 0 0 0 !important;
    padding: 0 0 0 0 !important;">
				  <?php echo $resultat_site_internet11_2['specification'] ?>
				</ul>
				<br>
			<ul class="" style="font-size: 12px;list-style:none;margin: 0 0 0 0 !important;
    padding: 0 0 0 0 !important;">
				  <?php echo $resultat_site_internet11_2['specification2'] ?>		
				</ul>
		  </div>
 
      <?php } ?>  
        <?php if(empty($resultat_site_internet11_2['age'])) { ?>
        
        <?php }else{ ?>
        <br>
        <div style="display: block;" align="center">
		<img src="image/age/<?php echo $resultat_site_internet11_2['age']; ?>.gif" title="<?php echo $resultat_site_internet11_2['age']; ?> ans et plus" alt="<?php echo $resultat_site_internet11_2['age']; ?> ans et plus" width="24" height="24">
		</div>
     ...
     <?php } ?>  
                  ...
                  <div align="center"> <?php echo $resultat_site_internet11_2['Paragraphe']; ?> </div>
                   
                   <p align="center" style="font-size: 22px;font-weight: 700;margin-top: 20px;padding-top: 13px;color: chocolate;padding-bottom: 38px;"><span class="fa fa-star" aria-hidden="true" style="top: 3px;"></span>  Pour lire la suite du test merci d'acheter un abonnement  <span class="fa fa-star" aria-hidden="true" style="top: 3px;"></span></p>
                   
                   <?php include('wp-includes/Php/Bloc_Premium_2.php'); ?>            
                   <?php } ?>
                    ...
                    <div align="center"><?php if(!empty($resultat_site_internet11_2['video'])) { ?>        
 						 <hr> 
                            <div align="center" style="margin-top: 30px;margin-bottom: 30px;">
                            <div><div class="dailymotion" align="center"><iframe frameborder="0" style="width: 800px;" height="500" src="<?php echo $resultat_site_internet11_2['video']; ?>" allowfullscreen=""></iframe></div> </div></div> 
                               <?php } ?>   </div>                                                
                                         <?php if(empty($resultat_site_internet11_2['Description2'])) { ?>
                        
                        <?php }else{ ?>
                               <hr>
                                <div class="story-conclusion" itemprop="summary" style="width: 100%;background-color: #00000059;margin-top: 30px;margin-bottom: 30px;"><p style="font-size: 13px;padding-left: 26px;padding-right: 26px;padding-top: 20px;padding-bottom: 20px;font-family: inherit;letter-spacing: 0.5px;"><b><?php echo $resultat_site_internet11_2['Description2']; ?></b></p></div>     
                               <?php } ?>
                               
                                <?php if(empty($resultat_site_internet11_2['pub'])) { ?>
                        <hr>
                        <?php }else{ ?>
                                 <hr>
                                 <div align="center" style="margin-top: 30px;margin-bottom: 30px;">	<a rel="nofollow" title="<?php echo $resultat_site_internet11_2['pub']; ?> " href="<?php echo $resultat_site_internet11_2['publien'] ?>" target="_blank">
		<b style="font-size:12px;"><?php echo $resultat_site_internet11_2['pub'] ?></b>
	</a>
</div>
      <hr>
       <?php } ?> 
                ...
                <div class="post-author">
                    <!-- BEGIN AUTHOR AVATAR -->
                    <a href="profil?pseudo=<?php echo $resultat_site_internet11_2['pseudo'] ?>" rel="author">
                        <img alt="" style="background-color: transparent;" src="image/avatar/<?php echo $resultat_site_internet11_2['createur'] ?>" class="avatar avatar-74 photo" height="74" width="74">                    </a>
                    <!-- END AUTHOR AVATAR -->
                    <!-- BEGIN AUTHOR DESCRIPTION -->
                    <div class="author-desc-wrapper">
                        <span class="author-name"><a href="profil?pseudo=<?php echo $resultat_site_internet11_2['createur'] ?>" rel="author"><?php echo $resultat_site_internet11_2['createur'] ?></a></span><span class="author-position">, Rédacteur et développeur</span>
                        <div class="author-description">
                ...
                <div class="post-tag" style="display: inline-block;">
                    Tag : <a rel="tag"><?php echo $resultat_site_internet11_2['Tags'] ?></a><span>               </div>
                    
					<div align="right" style="display: inline-block; float: right;"><span>Partager sur : </span>&nbsp;<a style="text-decoration: none;" href="//twitter.com/intent/tweet?original_referer=<?php echo $_SERVER['REQUEST_URI']; ?>&amp;url=https://over-games.fr<?php echo $_SERVER['REQUEST_URI']; ?>&amp;text=<?php echo $resultat_site_internet11_2['Titre']; ?> à lire @OverGames72" title="Partager sur Twitter" target="_blank">
                        <span class="icon-twitter"></span>
                    </a>&nbsp;<a style="text-decoration: none;" href="http://www.facebook.com/share.php?u=https://over-games.fr/jeux?item=<?php echo $resultat_site_internet11_2['item'] ?>" onclick="return xt_click(this,'C','','sharepage::partage_facebook','A');return false;" title="Partager sur Facebook" target="_blank">
                    ...
                    <div style="margin-top: 30px;">
                                                <span style="font-size:11px;float: left;display: block;margin-top: -4px;font-weight: bold;">Qualité du test :&nbsp;</span>	
                                                
  <?php 
			$actu4 = $cnx->prepare("SELECT * FROM test_ratings WHERE ip = :ip AND item = :item");
$actu4->execute(array(':item' => $_GET['item'], ':ip' => $_SERVER['REMOTE_ADDR']));
$acturesult4 = $actu4->fetch();
$actu4->closeCursor();			
						?>                                              		
                                                
<?php $rating = $resultat_site_internet11_2['rating']; ?>              		
       ...
       <?php } ?>  
        ...
        <!-- BEGIN RELATED STORIES -->
            ...
            <br>
               ...
               <?php while($resultat_sli_article = $sli_test->fetch()) { ?>
                ...
                <div class="related-stories-inner" style="background-image:url(<?php echo $resultat_sli_article['image'] ?>);">
                    <div class="related-stories-bg-gradient">
                        ...
                        <a href="/jeux?item=<?php echo $resultat_sli_article['item'] ?>">
                            <!-- BEGIN CATEGORIES (except 'featured' and 'highlighted') -->
                            <div class="related-category"><?php echo $resultat_sli_article['plateforme'] ?></div><div class="related-category"><?php echo $resultat_sli_article['plateforme'] ?></div>                        <!-- END CATEGORIES (except 'featured' and 'highlighted') -->
...
<div id="comments" class="commentwrap">
	...
	<div class="comments-wrapper">
		...
		<?php if(empty($resultat_commantaire3['item'])) { ?>
   ...
   ?>
	...
	<!-- .children -->
		...
		<!-- BEGIN COMMENT FORM -->
		        	<hr>
          <div class="related-stories-wrapper" style="margin-top: 20px;margin-bottom: 0px;">
			        <h3><?php if($resultat_commantaire3['item'] == "0") { ?>Soyez le premier à commenter<?php }else{ ?>Commenter <span style="font-weight: 100;">(<?php echo $resultat_commantaire3['item'] ?>)</span><?php } ?></h3>
	      </div>   
               	
               	<?php if(empty($_SESSION['email'])) { ?>
               	<div align="center"><a href="/tests#widgettitle" class="btn btn-outline-primary" title="Connectez vous pour poster un commentaire">Connectez vous pour poster un commentaire</a></div>
               	<?php }else{ ?>
		...
		<h3 id="reply-title" class="comment-reply-title"> <small><a rel="nofollow" id="cancel-comment-reply-link" href="index.htm#respond" style="display:none;"><span id="cancel-comment-reply"></span></a></small></h3>			
			...
			<form action="jeux-comments?item=<?php echo $_GET['item']; ?>" method="post" class="comment-form" id="Comment">
				<div class="commentform-wrapper"><div class="commentform-inner"><div class="commentform-outer-border"><div class="commentform-inner-border"><div id="comment-wrapper"><div class="comment-wrapper-inner"><textarea required name="message" id="message" cols="45" rows="10" tabindex="1" placeholder="Tapez votre commentaire ici pour rejoindre ou lancer la discussion ...*" style="height: 112px; overflow: hidden;"></textarea><input name="titre" type="hidden" id="titre" value="<?php echo $resultat_site_internet11_2['Titre']; ?>"></div></div></div></div></div></div>
			  <p class="form-submit">
			  
			  <?php if(date('Y-m-d h:i:s A') > date($resultat_commantaire4['heure_fin'])) { ?>
	...
	$heure_de_fin1 = $resultat_commantaire4['heure_fin'];
...
<?php if($_GET['commentaire'] == "oui")
	...
	window.history.pushState(document.title,document.title,"/jeux?item=<?php echo $_GET['item']; ?>");
	}, 2000);
</script>
 ...
 <script>
    jQuery(document).ready(function(evt){
      jQuery("#voteplus").click(function() {
         jQuery("#ratings").load("rating-jeux?item=<?php echo $_GET['item']; ?>")
      	return false;
	  })
...
<script>
    jQuery(document).ready(function(evt){
      jQuery("#votemoins").click(function() {
         jQuery("#ratings").load("rating-delete-jeux?item=<?php echo $_GET['item']; ?>")
      	return false;
	  })
