...
<meta charset="utf-8">
	...
	<title><?php echo $resultat_site_internet['Titre_Page_Head']; ?> | <?php echo $resultat_site_internet['Titre_Page']; ?></title>
	<meta name="description" content="<?php echo $resultat_site_internet['Description_Page']; ?>">
	<meta name="author" content="<?php echo $resultat_site_internet['Créateur_Page']; ?>">
	<link rel="icon" type="image/png" href="<?php echo $resultat_site_internet['Favicon_Page']; ?>">
...
<style>
  @font-face {
    ...
    src: url("wp-includes/font/MountainBridge.otf") format("opentype");
}  
</style>   
        ...
        <!-- BEGIN LOOP (large featured story) -->
            ...
            <div class="featured-stories-inner" style="background-image:url(<?php echo $slider_result['Image'] ?>);">
                <div class="featured-stories-bg-gradient">
                    ...
                    <a href="article?id=<?php echo $slider_result['id'] ?>">
                        <!-- BEGIN CATEGORIES (except 'featured' and 'highlighted') -->
                        <div class="featured-category"><?php echo $slider_result['Cat'] ?></div>                    <!-- END CATEGORIES (except 'featured' and 'highlighted') -->

                        <div class="featured-title-wrapper">
                            <!-- BEGIN COMMENT COUNT (if post has comments) -->
                                                            <div class="comment-count-bubble">
                                    <span>
                                        <?php echo $slider_result['comment'] ?>                                   </span>
                                </div>
                                                        <!-- END COMMENT COUNT (if post has comments) -->
                            <h2><?php echo $slider_result['Titre'] ?></h2>
                            <div class="featured-author-time">Par <?php echo $slider_result['Createur'] ?> // <?php echo $slider_result['Date'] ?></div>
                        </div>
                    </a>
...
<div class="featured-small-wrapper">
    ...
    <!-- BEGIN LOOP (small featured stories) -->
        ...
        <div class="featured-stories-inner" style="background-image:url(<?php echo $slider_result2['Image'] ?>);">
            <div class="featured-stories-bg-gradient">
                ...
                <a href="article?id=<?php echo $slider_result2['id'] ?>">
                    <!-- BEGIN CATEGORIES (except 'featured' and 'highlighted') -->
                    <div class="featured-category"><?php echo $slider_result2['Cat'] ?></div>                    <!-- END CATEGORIES (except 'featured' and 'highlighted') -->

                    <div class="featured-title-wrapper">
                        <!-- BEGIN COMMENT COUNT (if post has comments) -->
                                                    <div class="comment-count-bubble">
                                <span>
                                   <?php echo $slider_result2['comment'] ?>                              </span>
                            </div>
                                                <!-- END COMMENT COUNT (if post has comments) -->
                        <h2><?php echo $slider_result2['Titre'] ?></h2>
                        <div class="featured-author-time">Par <?php echo $slider_result2['Createur'] ?> // <?php echo $slider_result2['Date'] ?></div>
                    </div>
                </a>
        ...
        <div class="featured-stories-inner" style="background-image:url(<?php echo $slider_result3['image'] ?>);">
            <div class="featured-stories-bg-gradient">
                ...
                <a href="jeux?item=<?php echo $slider_result3['item'] ?>">
                    <!-- BEGIN CATEGORIES (except 'featured' and 'highlighted') -->
                    <div class="featured-category">Test</div>                   <!-- END CATEGORIES (except 'featured' and 'highlighted') -->

                    <div class="featured-title-wrapper">
                        <!-- BEGIN COMMENT COUNT (if post has comments) -->
                                                <!-- END COMMENT COUNT (if post has comments) -->
                        <h2><?php echo $slider_result3['Titre'] ?></h2>
                        <div class="featured-author-time">Par <?php echo $slider_result3['createur'] ?> // <?php echo $slider_result3['date'] ?></div>
                    </div>
                </a>
...
</div>                <!-- END INCLUDE FEATURED AREA -->
 
 <div class="condition">
 

 <div><img src="https://over-games.fr/image/5Hg9v1qwC0qX5plnmcoNiCgpWG4.png" style="width: 100%; opacity: 0.6;"></div>
...
<style>
	...
	.galerie_select:hover
	{
		opacity: 1.0;
	}
</style>
 
<hr style="width: 100%;margin-top: -16px;margin-bottom: 34px;">

<p align="center" style="margin-top: -7px;margin-bottom: 18px;">Les dernières images mises en ligne</p>
  
 <?php while($resultat_galerie_index = $galerie_index->fetch()) { ?> 
 	<div data-toggle="modal" data-target="#gallerie_<?php echo $resultat_galerie_index['id'] ?>" class="galerie_select" align="center" style="display: inline-block;margin-left: 12px;margin-right: 7px; cursor: crosshair;"><img style="width: 335px;opacity: 0.7;border-radius: 3px;box-shadow: -1px -9px 20px 0px #ffffff26;border: 3px solid #170d0d8c;" src="https://over-games.fr/<?php echo $resultat_galerie_index['image'] ?>" alt="<?php echo $resultat_galerie_index['titre'] ?>">
 	
 	<div style="margin-top: 11px;">
 	
 	<img src="https://over-games.fr/image/heart2.png" style="opacity: 1 !important;width: 17px;height: 17px;display: inline-block;"><div style="opacity: 1 !important;color: white;margin-left: 5px;font-weight: bold;font-size: 15px;font-family: arial;display: inline-block;margin-top: -1px;position: absolute;"><span id="hearth_<?php echo $resultat_galerie_index['id'] ?>"><?php echo $resultat_galerie_index['rating'] ?></span></div></div>
 	
 	</div>
<?php } ?>

<hr style="margin-top: 38px;margin-bottom: -23px;">
...
.tri-right.left-in:after {
    ...
    bottom: auto;
    border: 12px solid;
    border-color: #e8e8e896 #e8e8e89c transparent transparent;
}
...
<div class="blog-index-date none">
                                Dernière publication                          </div>
                           
                            <div class="loop-index-top-border"></div>
                            
<?php while($slider_result4 = $slider4->fetch()) { ?>     
    ...
    background-color: transparent;
            ...
            <div class="title-excerpt-wrapper">
                ...
                <div class="post-excerpt">
                    ...
                    <!-- BEGIN EXCERPT -->
                   <?php
                   	$mytext = $slider_result4['Paragraphe'];
...
<?php } ?> 
                                    ...
                                    <!-- BEGIN HIGHLIGHTED POSTS MARKER -->
            <div class="necessary-wrapper-for-index">
                                <div class="highlighted-posts-marker2">
...
<?php while($slider_result4 = $slider6->fetch()) { ?>     
    ...
    <a href="jeux?item=<?php echo $slider_result4['item'] ?>">
        ...
        <div class="loop-index-inner">
            ...
            <div class="title-excerpt-wrapper">
                ...
                <!-- BEGIN CONTENT -->
                <div class="post-excerpt" style="margin-top: -7px;">
                    <!-- BEGIN TIME + DATE -->
                     <br>
                     <span style="font-weight: bold;font-style: oblique;color: #1eeaff;">[<?php echo $slider_result4['plateforme'] ?>]</span>
...
<?php } ?>
    <?php include('wp-includes/Php/Login.php'); ?>
    </div>
    <!-- END SIDEBAR -->
    
    
 
    <?php include('wp-includes/Php/LectureSeul.php'); ?>
    ...
    <style>
    	...
    	.btn-yt:hover
    	{
    		background-color:#8209098c !important;
    ...
    <div align="center"><img style="display: inline-block;margin-right: 15px;width: 8%;" src="image/6196.png"> <span style="display: inline-block;color: white;font-weight: bold;font-size: 18px;letter-spacing: 8px;">Les Youtubers à découvrir</span></div>
    ...
    <a target="_blank" href="https://www.youtube.com/user/gussdxvideo" class="picture-yt" title="Suivre GussDx" style="display: inline-block; margin-right:15px;margin-left:15px;"><img style="border-radius: 88px;" src="https://yt3.ggpht.com/a/AATXAJy2W0bHOWUhZhJnsCxUmzt4-4U98YS7EZlOxi5Axg=s176-c-k-c0x00ffffff-no-rj-mo"></a>
    <a target="_blank" href="https://www.youtube.com/user/UbisoftFR" class="picture-yt" title="Suivre Ubisoft FR" style="display: inline-block; margin-right: 15px;margin-left:15px"><img style="border-radius: 88px;" src="https://yt3.ggpht.com/a/AATXAJxTcHSvxJvjX2LQkkoNpFVQ9XIEJ8rf-DpIYMiLSg=s176-c-k-c0x00ffffff-no-rj-mo"></a>
    <a target="_blank" href="https://www.youtube.com/channel/UCL-g3eGJi1omSDSz48AML-g" class="picture-yt" title="Suivre NVIDIA GeForce" style="display: inline-block; margin-right: 15px;margin-left:15px"><img style="border-radius: 88px;" src="https://yt3.ggpht.com/a/AATXAJyoTr-I7j88enshM0e6LVT6VDOXrJHNmYcGt2rv2A=s176-c-k-c0x00ffffff-no-rj-mo"></a>
    <a target="_blank" href="https://www.youtube.com/user/CorsairMemoryInc" class="picture-yt" title="Suivre Corsair" style="display: inline-block; margin-right: 15px;margin-left:15px"><img style="border-radius: 88px;" src="https://yt3.ggpht.com/a/AATXAJxPN9JGXaO4Fx0FhS54fFU8vKuhY086tYfMW5w7qg=s176-c-k-c0x00ffffff-no-rj-mo"></a>
    <a target="_blank" href="https://www.youtube.com/user/RoG" class="picture-yt" title="Suivre ROG Global" style="display: inline-block; margin-right: 15px;margin-left:15px"><img style="border-radius: 88px;" src="https://yt3.ggpht.com/a/AATXAJxLtERD9s3PjUV0DYVy9WSw9bKEG803MzRdxrqdLg=s176-c-k-c0x00ffffff-no-rj-mo"></a>
    
    
   	

<div style="width: 181px;font-weight: bold;margin-top: 19px;color: white;padding-right: 12px;padding-left: 12px;display: inline-block;border-right: 1px solid #564949;border-left: 1px solid #564949;" align="center">
   	<a target="_blank" href="https://www.youtube.com/user/gussdxvideo"><div align="right" class="btn btn-yt" style="width: 106px;height: 23px;color: white;padding-top: 6px;background-color: #820909;">
                    <span style="font-size: 15px;font-weight: 700;">GussDx</span>
                    <span class=""> <i class="fab fa-youtube" aria-hidden="true"></i></span>
                </div></a><br><br>

<i class="fa fa-users" aria-hidden="true" style="color: aquamarine;"></i>&nbsp;&nbsp;<span id="subscribers" class="style-scope ytd-channel-renderer" style="color: aquamarine;">538&nbsp;k&nbsp;abonnés</span><br><br>
   	<i class="fab fa-youtube" aria-hidden="true" style="color: #ec0c0c;"></i>&nbsp;&nbsp;<span id="video-count" class="style-scope ytd-channel-renderer" style="color: #ec0c0c;">313&nbsp;vidéos</span><br><br>
   	<i class="fa fa-pencil" aria-hidden="true" style="color: olivedrab;"></i>&nbsp;&nbsp;<yt-formatted-string id="description" class="style-scope ytd-channel-renderer" style="color: olivedrab;"><span dir="auto" class="style-scope yt-formatted-string">Chasseur de Fantômes est une série de reportages de terrain en solitaire consacrés à la détection et la capture d’événements sortant de l’ordinaire</span></yt-formatted-string>	
	</div>

<div style="width: 181px;font-weight: bold;margin-top: 19px;color: white;padding-right: 12px;padding-left: 12px;display: inline-block;border-right: 1px solid #564949;" align="center">
   	<a target="_blank" href="https://www.youtube.com/user/UbisoftFR"><div align="right" class="btn btn-yt" style="width: 106px;height: 23px;color: white;padding-top: 6px;background-color: #820909;">
                    <span style="font-size: 15px;font-weight: 700;">Ubisoft FR</span>
                    <span class=""> <i class="fab fa-youtube" aria-hidden="true"></i></span>
                </div></a><br><br>

<i class="fa fa-users" aria-hidden="true" style="color: aquamarine;"></i>&nbsp;&nbsp;<span id="subscribers" class="style-scope ytd-channel-renderer" style="color: aquamarine;">161 k abonnés</span><br><br>
   	<i class="fab fa-youtube" aria-hidden="true" style="color: #ec0c0c;"></i>&nbsp;&nbsp;<span id="video-count" class="style-scope ytd-channel-renderer" style="color: #ec0c0c;">1 311 vidéos</span><br><br>
   	<i class="fa fa-pencil" aria-hidden="true" style="color: olivedrab;"></i>&nbsp;&nbsp;<yt-formatted-string id="description" class="style-scope ytd-channel-renderer" style="color: olivedrab;"><span dir="auto" class="style-scope yt-formatted-string">Bienvenue sur la chaîne Youtube officielle d'Ubisoft France. Retrouvez tous les trailers officiels en HD et en français, de toutes ...</span></yt-formatted-string>	<br><br>
	</div>

<div style="width: 181px;font-weight: bold;margin-top: 19px;color: white;padding-right: 12px;padding-left: 12px;display: inline-block;border-right: 1px solid #564949;" align="center">
   	<a target="_blank" href="https://www.youtube.com/channel/UCL-g3eGJi1omSDSz48AML-g"><div align="right" class="btn btn-yt" style="width: 136px;height: 23px;color: white;padding-top: 6px;background-color: #820909;">
                    <span style="font-size: 15px;font-weight: 700;">NVIDIA GeForce</span>
                    <span class=""> <i class="fab fa-youtube" aria-hidden="true"></i></span>
                </div></a><br><br>

<i class="fa fa-users" aria-hidden="true" style="color: aquamarine;"></i>&nbsp;&nbsp;<span id="subscribers" class="style-scope ytd-channel-renderer" style="color: aquamarine;">937 k abonnés</span><br><br>
   	<i class="fab fa-youtube" aria-hidden="true" style="color: #ec0c0c;"></i>&nbsp;&nbsp;<span id="video-count" class="style-scope ytd-channel-renderer" style="color: #ec0c0c;">1189&nbsp;vidéos</span><br><br>
   	<i class="fa fa-pencil" aria-hidden="true" style="color: olivedrab;"></i>&nbsp;&nbsp;<yt-formatted-string id="description" class="style-scope ytd-channel-renderer" style="color: olivedrab;"><span dir="auto" clas	s="style-scope yt-formatted-string">Your definitive source for the best in PC gaming, modding, and tech! Join us for exclusive, high-res game content and previews of ...</span></yt-formatted-string><br><br>	
	</div>

<div style="width: 181px;font-weight: bold;margin-top: 19px;color: white;padding-right: 12px;padding-left: 12px;display: inline-block;border-right: 1px solid #564949;border-left: blue;" align="center">
   	<a target="_blank" href="https://www.youtube.com/user/CorsairMemoryInc"><div align="right" class="btn btn-yt" style="width: 106px;height: 23px;color: white;padding-top: 6px;background-color: #820909;">
                    <span style="font-size: 15px;font-weight: 700;">Corsair</span>
                    <span class=""> <i class="fab fa-youtube" aria-hidden="true"></i></span>
                </div></a><br><br>

<i class="fa fa-users" aria-hidden="true" style="color: aquamarine;"></i>&nbsp;&nbsp;<span id="subscribers" class="style-scope ytd-channel-renderer" style="color: aquamarine;">416&nbsp;k&nbsp;abonnés</span><br><br>
   	<i class="fab fa-youtube" aria-hidden="true" style="color: #ec0c0c;"></i>&nbsp;&nbsp;<span id="video-count" class="style-scope ytd-channel-renderer" style="color: #ec0c0c;">468&nbsp;vidéos</span><br><br>
   	<i class="fa fa-pencil" aria-hidden="true" style="color: olivedrab;"></i>&nbsp;&nbsp;<yt-formatted-string id="description" class="style-scope ytd-channel-renderer" style="color: olivedrab;"><span dir="auto" class="style-scope yt-formatted-string">Corsair is a global company bringing innovative, high-performance components to the PC gaming market. Specializing in very ...</span></yt-formatted-string><br><br>	
	</div><div style="width: 181px;font-weight: bold;margin-top: 19px;color: white;padding-right: 12px;padding-left: 12px;display: inline-block;border-right: 1px solid #564949;border-left: 1px solid #564949;" align="center">
   	<a target="_blank" href="https://www.youtube.com/user/RoG"><div align="right" class="btn btn-yt" style="width: 106px;height: 23px;color: white;padding-top: 6px;background-color: #820909;">
                    <span style="font-size: 15px;font-weight: 700;">ROG Global</span>
                    <span class=""> <i class="fab fa-youtube" aria-hidden="true"></i></span>
                </div></a><br><br>

<i class="fa fa-users" aria-hidden="true" style="color: aquamarine;"></i>&nbsp;&nbsp;<span id="subscribers" class="style-scope ytd-channel-renderer" style="color: aquamarine;">364&nbsp;k&nbsp;abonnés</span><br><br>
   	<i class="fab fa-youtube" aria-hidden="true" style="color: #ec0c0c;"></i>&nbsp;&nbsp;<span id="video-count" class="style-scope ytd-channel-renderer" style="color: #ec0c0c;">630&nbsp;vidéos</span><br><br>
   	<i class="fa fa-pencil" aria-hidden="true" style="color: olivedrab;"></i>&nbsp;&nbsp;<yt-formatted-string id="description" class="style-scope ytd-channel-renderer" style="color: olivedrab;"><span dir="auto" class="style-scope yt-formatted-string">The Official YouTube channel for the ASUS ROG Join the Republic !</span></yt-formatted-string><br><br><br><br>	
	</div>
 ...
 <div align="center" style="margin-top: 8px;margin-bottom: -46px;"><img src="https://over-games.fr/image/unnamed.png" style="width: 53%;"></div>
