...
<meta charset="utf-8">
	...
	<title><?php echo $resultat_site_internet23['Titre_Page_Head']; ?> | <?php echo $resultat_site_internet23['Titre_Page']; ?></title>
	<meta name="description" content="<?php echo $resultat_site_internet23['Description_Page']; ?>">
	<meta name="author" content="<?php echo $resultat_site_internet23['Créateur_Page']; ?>">
	<link rel="icon" type="image/png" href="<?php echo $resultat_site_internet23['Favicon_Page']; ?>">
...
<div align="center">
  <h1 style="color: white;">Notre site internet fait peau neuve</h1><br>
  <p style="color: white;">En attendant sa mise en ligne vous pouvez naviguer sur nos autres sites internet Games Actus <a href="https://games-actus.fr/">Games-Actus.fr</a>.</p>
</div>
