...
$sliderbonplan = $cnx->prepare('SELECT * FROM Actualite WHERE Cat = :Cat ORDER BY id DESC LIMIT ' . $limite . ', ' . $pagination);
$sliderbonplan->execute(array(':Cat' => "TOKYO GAME SHOW 2020 (TGS)"));

$i = $cnx->prepare("SELECT * FROM Actualite WHERE Cat = :Cat ORDER BY id DESC");
$i->execute(array(':Cat' => "TOKYO GAME SHOW 2020 (TGS)"));
$x = $i->rowCount();
...
<meta charset="utf-8">
	...
	<title><?php echo $resultat_site_internet26['Titre_Page_Head']; ?> | <?php echo $resultat_site_internet26['Titre_Page']; ?></title>
	<meta name="description" content="<?php echo $resultat_site_internet26['Description_Page']; ?>">
	<meta name="author" content="<?php echo $resultat_site_internet26['Créateur_Page']; ?>">
	<link rel="icon" type="image/png" href="<?php echo $resultat_site_internet26['Favicon_Page']; ?>">
...
.bb3 {
  ...
  height: 200px;
  margin: auto;
  background: url(image/PinClipart.com_joker-clipart_2555981.png) no-repeat -163px 40px rgba(0, 0, 0, 0.1);
  color: #69ca62;
  box-shadow: inset 0 0 0 1px rgba(105, 202, 98, 0.5);
}
...
<div class="index-main-wrapper">
	...
	<p align="center">TOKYO GAME SHOW 2020 (TGS)</p>
...
.parcel {
  ...
  animation: pop 1.2s infinite;
   ...
   <br><br><br><br><br><br><br><br><br><br><br><br>
    <div class="parcel"><img style="width: 62%" src="image/icon.png"></div>   
...
<?php while($slider_result4 = $sliderbonplan->fetch()) { ?>     
                                        
<div class="loop-index-wrapper">
    <a target="_blank" href="article?id=<?php echo $slider_result4['id'] ?>">
        <div class="loop-index-inner">
            ...
            <div class="featured-image" style="background-image:url(<?php if($slider_result4['ImagePetite'] == "") { 
				echo $slider_result4['Image']; 
			}else{ 
				echo $slider_result4['ImagePetite']; 
						 } ?>);">
...
<div style="margin-bottom: 10px;margin-top: 10px;" align="center"><img style="display: inline-block;margin-right: 4px;width: 6%;" src="https://pngimg.com/uploads/twitch/twitch_PNG18.png"> <span style="display: inline-block;color: white;font-weight: bold;font-size: 18px;letter-spacing: 6px;">CAPCOM TGS LIVE 2020 DAY-1 &amp; DAY-2</span></div>

    
    <!-- Add a placeholder for the Twitch embed -->
<div style="margin-top: 10px;" id="twitch-embed" align="center"></div>
    ...
    <div class="post-nav-inner">
       ...
       <?php
                   ...
                   ?>
                       ...
                       <a class="page-numbers<?php if($_SERVER['REQUEST_URI'] == "/tgs?page=1" OR $_SERVER['REQUEST_URI'] == "/tgs") { ?> current<?php } ?>" href="tgs?page=1">1</a>  
						<?php } ?>


  <?php for ($i = 2 ; $i <= $nb_pages -21 ; $i++)
{  ?>
      
           		<a class="page-numbers<?= ($_GET['page'] == $i) ? " current" : "" ?>" href="tgs?page=<?php echo $i ?>"><?php echo $i ?></a>
         ...
         <?php
						if($nb_pages != $_GET['page']) {
                   ?>
                    <a href="tgs?page=<?php echo $ligne1+$ligne2 ?>" class="next page-numbers">
                       &gt;
                    </a>
				<?php } ?>
   </div>
...
<?php } ?>
    ...
    <?php include('wp-includes/Php/Login_Tgs.php'); ?>
