...
$sliderbonplan->execute(array(':Cat' => "LES BONS PLANS"));

$i = $cnx->prepare("SELECT * FROM Actualite WHERE Cat = :Cat ORDER BY id DESC");
$i->execute(array(':Cat' => "LES BONS PLANS"));
$x = $i->rowCount();
...
<meta charset="utf-8">
	...
	<title><?php echo $resultat_site_internet25['Titre_Page_Head']; ?> | <?php echo $resultat_site_internet25['Titre_Page']; ?></title>
	<meta name="description" content="<?php echo $resultat_site_internet25['Description_Page']; ?>">
	<meta name="author" content="<?php echo $resultat_site_internet25['Créateur_Page']; ?>">
	<link rel="icon" type="image/png" href="<?php echo $resultat_site_internet25['Favicon_Page']; ?>">
...
<div class="index-main-wrapper">
	...
	<p align="center">Nos bon plans</p>
...
.parcel {
  ...
  animation: pop 1.2s infinite;
   ...
   <br><br><br><br><br><br><br><br><br><br><br><br>
    <div class="parcel"><img style="width: 80%" src="image/helmet_skull_racer_emoji_icon_149304.png"></div>   
...
<div class="loop-index-wrapper">
    <a target="_blank" href="<?php echo $slider_result4['BonPlansLien'] ?>">
...
"> Abonné </span></i></span>
            ...
            <div class="title-excerpt-wrapper">
                ...
                <div class="post-excerpt">
                    ...
                    <!-- END TIME + DATE -->
                    <!-- BEGIN EXCERPT -->
                    <?php echo substr($slider_result4['Paragraphe'], 0, 60).'...'; ?>
    ...
    <div class="post-nav-inner">
       ...
       <?php
                   ...
                   ?>
                       ...
                       <a class="page-numbers<?php if($_SERVER['REQUEST_URI'] == "/bon-plans?page=1" OR $_SERVER['REQUEST_URI'] == "/bon-plans") { ?> current<?php } ?>" href="bon-plans?page=1">1</a>  
						<?php } ?>
...
{  ?>
           		...
           		<a class="page-numbers<?= ($_GET['page'] == $i) ? " current" : "" ?>" href="bon-plans?page=<?php echo $i ?>"><?php echo $i ?></a>
         ...
         <?php
						if($nb_pages != $_GET['page']) {
                   ?>
                    <a href="bon-plans?page=<?php echo $ligne1+$ligne2 ?>" class="next page-numbers">
                       &gt;
                    </a>
				<?php } ?>
   </div>
...
<?php } ?>
    ...
    <?php include('wp-includes/Php/Login_Plans.php'); ?>
