...
<button type="submit" class="btn btn-outline-primary">S'inscrire</button>
      ...
      <div align="center"><a href="" style="display: inline-block;" id="inscriptionbtn">S'inscrire ?</a>&nbsp;&nbsp;<a href="" id="signin">Mot de passe oublié ?</a></div>
       ...
       <?php } ?>
        ...
        <h4 class="widgettitle">Trier par Catégorie</h4>
        
        <div class="tagcloud">
        
       
        
	<a class="tag-link-34 tag-link-position-1" style="font-size: 8pt;" id="PC" href="">Pc</a>
	<a class="tag-link-34 tag-link-position-2" style="font-size: 8pt;" id="XONE" href="">Xbox One</a>
	<a class="tag-link-34 tag-link-position-3" style="font-size: 8pt;" id="XBOXSX" href="">XboxeSX</a>
	<a class="tag-link-34 tag-link-position-4" style="font-size: 8pt;" id="PS1" href="">Playstation 1</a>
	<a class="tag-link-34 tag-link-position-6" style="font-size: 8pt;" id="PS2" href="">Playstation 2</a>
	<a class="tag-link-34 tag-link-position-7" style="font-size: 8pt;" id="PS3" href="">Playstation 3</a>
	<a class="tag-link-34 tag-link-position-8" style="font-size: 8pt;" id="PS4" href="">Playstation 4</a>
	<a class="tag-link-34 tag-link-position-9" style="font-size: 8pt;" id="PS5" href="">Playstation 5</a>
	<a class="tag-link-34 tag-link-position-10" style="font-size: 8pt;" id="X360" href="">Xbox 360</a>
	<a class="tag-link-34 tag-link-position-11" style="font-size: 8pt;" id="WiiU" href="">Nintendo Wii U</a>
	<a class="tag-link-34 tag-link-position-12" style="font-size: 8pt;" id="PSP" href="">Playstation Portable</a>
	<a class="tag-link-34 tag-link-position-13" style="font-size: 8pt;" id="PSV" href="">Ps Vita</a>
	<a class="tag-link-34 tag-link-position-14" style="font-size: 8pt;" id="DS" href="">Nintendo Ds</a>
	<a class="tag-link-34 tag-link-position-15" style="font-size: 8pt;" id="3DS" href="">Nintendo 3Ds</a>
	<a class="tag-link-34 tag-link-position-16" style="font-size: 8pt;" id="IPHONE" href="">Iphone / Ipad</a>
	<a class="tag-link-34 tag-link-position-18" style="font-size: 8pt;" id="AND" href="">Android</a>
	<a class="tag-link-34 tag-link-position-19" style="font-size: 8pt;" id="Switch" href="">Nintendo Switch</a>
	<a class="tag-link-34 tag-link-position-19" style="font-size: 8pt;" id="Stadia" href="">Stadia</a>
   ...
   <img style="width: 100px; height: 100px;" src="image/Jaquette/<?php echo $test_resultat['jaquette'] ?>" class="attachment-powerup-widget-thumb size-powerup-widget-thumb wp-post-image" alt="<?php echo $test_resultat['Titre'] ?>">                                                            </div>
	...
	<?php } ?>
		  ...
		  <div id="recent-posts-3" class="widget widget_recent_entries">
                   				<h4 class="widgettitle">Guide achat</h4>               
                   				 <ul>
                    		
                    		<?php while($guide_achat_resultat = $guide_achat->fetch()) { ?>		
                    								
                    <li>
                            
                       
                        <a id="article-<?php echo $guide_achat_resultat['id']; ?>" class="powerup-latest-widget" href="<?php echo $guide_achat_resultat['Lien'] ?>">
                            <!-- BEGIN featured image -->
                            <div class="featured-image">
   <img style="width: 100px; height: 100px;" src="<?php if(empty($guide_achat_resultat['ImageLien'])) { ?>image/Achat/<?php echo $guide_achat_resultat['Image'] ?><?php }else{ ?><?php echo $guide_achat_resultat['ImageLien'] ?><?php } ?>" class="attachment-powerup-widget-thumb size-powerup-widget-thumb wp-post-image" alt="<?php echo $guide_achat_resultat['Titre'] ?>">                                                            </div>
                            <!-- END featured image -->
                            <!-- BEGIN title + date -->
                            <div class="powerup-latest-widget-post-title"><?php echo $guide_achat_resultat['Titre'] ?></div>
                            
                            <div class="powerup-latest-widget-Tags"><?php echo $guide_achat_resultat['Tags1'] ?></div>
            
                            <div class="powerup-latest-widget-date">Mise en ligne : <?php echo $guide_achat_resultat['Date'] ?></div>  
